...
from src.ocr_evaluation.utils import clean_ground_truth
...
def evaluate_easyocr(dataset_path, annotation_file, num_images=None):
    ...
    csv_output_path = os.path.join(PROCESSED_DATA_DIR, 'results_total_text.csv')
    ...
    json_output_path = os.path.join(dataset_path, 'ocr_results_total_text.json')
...
def main():
    """Оценка EasyOCR на Total_text."""
    dataset_path = DATA_DIR
    annotation_file = os.path.join(PROCESSED_DATA_DIR, 'total_text_test.csv')
